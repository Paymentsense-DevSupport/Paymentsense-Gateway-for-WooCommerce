...
if ( ! defined( 'get_country_iso_code' ) ) {
	/**
	 ...
	 * @return string
	 */
	function get_country_iso_code( $country_code ) {
		$result    = '';
		$iso_codes = array(
			'AL' => '8',
			'DZ' => '12',
...
if ( ! defined( 'get_currency_iso_code' ) ) {
	/**
	 ...
	 * @return string
	 */
	function get_currency_iso_code( $currency_code, $default_code = '826' ) {
		$result    = $default_code;
		$iso_codes = array(
			'GBP' => '826',
			'USD' => '840',
