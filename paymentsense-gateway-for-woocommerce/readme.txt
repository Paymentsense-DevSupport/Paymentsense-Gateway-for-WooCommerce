...
* WooCommerce 3.x (tested up to 3.5.7). Warning: WooCommerce 3.5.0 and 3.5.1 contain a bug that affects the Hosted payment method of the Paymentsense plugin.
