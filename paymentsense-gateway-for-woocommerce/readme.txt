...
* WordPress 4.4 or greater (tested up to 5.1.1)
* WooCommerce 3.x (tested up to 3.6.1). Warning: WooCommerce 3.5.0 and 3.5.1 contain a bug that affects the Hosted payment method of the Paymentsense plugin.
